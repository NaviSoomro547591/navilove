...
name = raw_input ("\033[91mAp ka Nama ?(lovehackerNama Real) : ")																	
																	
if name == (""):																	
     print '\x1b[1;92mReal Nama istmal karain Lovehacker :V'																	
     os.sys.exit()																	
     os.sys.exit()																	
...
if password == ("03151828547"):																	
     os.system('clear')																	
																	
     print 'Assalamu.alaikum ' + name + ' Welcome'																	
     time.sleep(0.8)																	
     print 'Welcome ' + name + ' naveedlover'																	
     time.sleep(0.8)																	
     print 'Semoga beruntung ' + name + ' naveedlover'																	
     time.sleep(0.8)																	
     ...
     time.sleep(0.8)																	
     print 'lovehacker ' + name + ' Agar Facebook  tools Galat ho gaya  <https://www.facebook.com/rendi.andika.3133>'																	
     time.sleep(0.8)																	
     print '[*]Ingat Ya Untuk ' + name + ' [~]Untuk Fb anda tidak Sesi/Kekunci Login Opera mini..!!'																	
     time.sleep(1.2)																	
     																	
else:																	
     print ("Ap ka Darj kia password Galat ha naveedlover sy help lain (+03151828547)")																	
     os.sys.exit()																	
#-Out-#																	
def keluar():																	
